...
XLSX.prototype = {
  ...
  processWorksheetEntry: function(entry, model, options) {
  ...
  write: function(stream, options) {
    ...
    return PromishLib.Promish.resolve()
      ...
      .then(() => this.addSharedStrings(zip, model)) // WARNING: moved to the top, because previosly worksheets were not parsed correctly
